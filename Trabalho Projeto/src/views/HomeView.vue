    ...
    <div class="card-group">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            6 dias em Orlando, com passagem de ida e volta, estadia em hotel a 300 metros do parque, almoço e guia turistico inclusos.
            <br />
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">
            4 dias na Cidade dos samurais, com passagem de ida e volta, estádia
            em em pousada a 600 metros do centro, almoço e guia turistico inclusos.
            <br />
